...
export default function AddDevicePage() {
  ...
  return (
    <div style={s.page}>
      ...
      <p style={s.subtitle}>Pair your child's device using a one-time code.</p>
      ...
      {step === 1 && (
        <div style={s.card}>
          ...
          <form onSubmit={generate} style={s.form}>
            <input style={s.input} value={deviceName} onChange={(e) => setDeviceName(e.target.value)} placeholder="e.g. Alex's MacBook" required />
      ...
      {step === 2 && code && (
        <div style={s.card}>
          <h3 style={s.cardTitle}>Step 2: Enter this code on the child's device</h3>
          <div style={s.codeBox}>
          ...
          <div style={s.waitRow}>
            <div style={s.spinner} />
            <span style={{ color: '#6b7280', fontSize: 14 }}>Waiting for the device to connect...</span>
          </div>
      ...
      {step === 3 && (
        <div style={{ ...s.card, textAlign: 'center', padding: 48 }}>
          ...
          <h3 style={{ ...s.cardTitle, textAlign: 'center', marginTop: 16 }}>Device connected!</h3>
