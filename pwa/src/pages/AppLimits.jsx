...
export default function AppLimits() {
  ...
  async function save(updatedLimits) {
    setSaving(true);
    setSaved(false);
    try {
  ...
  function updateLimit(i, field, value) {
        ...
        <div style={styles.addRow}>
          ...
          <div style={styles.minutesWrap}>
            <input
              ...
              value={newLimit.daily_limit_minutes}
